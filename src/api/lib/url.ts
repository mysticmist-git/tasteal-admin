...
export const ApiEndPoint = {
  ...
  GetAllComments: () => CreateUrl(`Comment/getAll`),
  GetCommentById: (id: number) => CreateUrl(`Comment/${id}`),
  SoftDelete: (id: number) => CreateUrl(`Comment/softDelete/${id}`),
  HardDelete: (id: number) => CreateUrl(`Comment/hardDelete/${id}`),
  //
  // CookBook
